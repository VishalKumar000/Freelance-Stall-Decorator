...
const WeAreHiring = () => {
  return (
    <section className="w-full bg-[#f7f7f8] text-[#303030] py-10 relative before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:overflow-hidden before:bg-[#f7f7f8] before:transition-all hover:before:w-[101%] hover:before:h=[150%]">
