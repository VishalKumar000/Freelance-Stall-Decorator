...
const WeAreHiring = () => {
  return (
    <section className="w-full bg-[#090909] text-white py-10 relative before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:overflow-hidden before:bg-[#000] before:transition-all hover:before:w-[101%] hover:before:h=[150%]">
