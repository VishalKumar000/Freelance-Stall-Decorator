    ...
    <section className="w-full bg-black text-white py-14">
      <div className="w-full max-w-[1200px] my-0 mx-auto px-10 lg:px-4 flex flex-col gap-8">
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div>
            <h4 className="text-md relative tracking-[2px] uppercase font-bold m-0 p-0 before:h-[1px] before:bg-white before:absolute before:translate-x-[-100%] before:left-[-50px] before:right-auto before:w-[150px] before:top-2/4">
              LET&apos;S TALK
            </h4>
